 ...
 * WIFI Settings
 **************************/
const char* WIFI_SSID = "Solaria";
const char* WIFI_PWD = "4rb0l4d4B13";
...
const char *api_key ="T4K0PJ29RGR34RRS";                  //Your own thingspeak api_key
const int httpPort = 80;
#define DHTPIN 12       // ESP8266-12E  D5 read temperature and Humidity data
...
String OPEN_WEATHER_MAP_APP_ID = "c27c0f6c37783cd47028b4018156c27d";
String OPEN_WEATHER_MAP_LOCATION = "Mexico,MX";
...
void readTemperatureHumidity(){
  ...
  temp = dht.readTemperature();  // no parameter read in celsius
  // check if read a wrong value
  if(isnan(humi) || isnan(temp) || (humi > 100) || (temp > 50))
  {
